...
# Database
# Default: sqlite for local development. If PostgreSQL env vars are present,
# configure Postgres for production/deployments with connection re-use for
# better performance (CONN_MAX_AGE) and atomic requests.
